...
+ Contract-Address: [0xC43d52C637D6b2505fCd125Cd37a771768C252bf](https://etherscan.io/address/0xC43d52C637D6b2505fCd125Cd37a771768C252bf)

### INTRODUCTION

Hello. We are new to this board - if you ask our profiles (primeRev and timeHash4096) - but we are here (silently) for years.

It's fun to browse this forum, but all this superlatives are annoying ("Our coin is the future of virtual currency", "The world's first ..."). Well, I know... We have just another ICO for you. An Ethereum ERC-20 smart contract token written in Solidity. Me and my development partner coded it in the last two months completely from scratch. No copy / paste / forking stuff. If you don't like it, just ignore it or flame this thread to hell. It's in your hands. But we believe this token contract gives something new to the community. We start it here in a tokensale and publish the contracts source code at Github to be examined, forked, modified and used by everyone with a good idea to kickstart some business idea.

By the way: Please excuse my poor English language skills. It's (obviously) not my native language (PM me for syntactic and grammatical  corrections). I (primeRev) was very lazy in school and more versed in computer languages. I am able to code in more than 20 computer languages from 6502-assembler-code (yes, I'm old) to Solidity. My co-developper is active in gfx-design and web-development and is supposed to create the frontend stuff while I'm coding the backend and crypto things. We are friends since since the study of computer science at the technical university of berlin. Today we are both deeply involved in the sector of professional and semi-professional photography and music production (greetings to radium, paradox and bubbazenetti) for the last 20 years.

To finish the ~~short~~ introduction, we have to say something which you can love or hate: There will be no fancy logos, glowing headlines and amazing gfx-effects here. We will not advertise this token as hell. There will be no airdrops, signature campains or giveaways. There will be no bounties to translate this in real english, ... or any other language. In return we do not list tons of (fake) supportes and incredible team-members from the marvel-universe here. We are just two normal guys with some development skills, some (hopefully good) business ideas ... and a *real live* absorbing most of our time.
...
##### To Buy MTI-Tokens:
* Wait until the ICO starts (25. November 2017 12:00pm UCT).
* Login to your myetherwallet.com (or any other compatible wallet, i.e.: MetaMask or the Mist-Wallet)
* Go to the "contract" section
* Enter the contract address: [0xC43d52C637D6b2505fCd125Cd37a771768C252bf](https://etherscan.io/address/0xC43d52C637D6b2505fCd125Cd37a771768C252bf) 
